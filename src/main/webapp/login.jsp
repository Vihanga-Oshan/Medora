...
<head>
    ...
    <link rel="stylesheet" href="css/login/login-patient.css" />
</head>
<body>
...
<div class="container">
    <div class="left-panel">
        <img src="assets/login-patient.jpg" alt="login image" class="register-image" />
    </div>
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <div class="toggle-buttons">
                    <button class="active" onclick="window.location.href='login.jsp'">Login as Guardian</button>
