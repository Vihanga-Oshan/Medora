        ...
        <body>
                ...
                <div class="container">
                    ...
                    <div class="steps-grid">
                        ...
                        <div class="step-card">
                            ...
                            <p>Medora intelligently creates a personalized medication schedule based on your
                                prescriptions.</p>
                        </div>
                        <div class="step-card">
                ...
                <div class="container">
                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            ...
                            <p>Receive intelligent, personalized reminders that adapt to your schedule and ensure
                                perfect timing.</p>
                        </div>
                        <div class="feature-card">
                        ...
                        <div class="feature-card">
                            ...
                            <p>Enable caregivers to remotely monitor medication adherence and provide support when
                                needed.</p>
                        </div>
                        <div class="feature-card">
                            <h3>HIPAA Compliant</h3>
                            <p>Bank-level encryption and security protocols protect your sensitive health information.
                            </p>
                        </div>
                        <div class="feature-card">
                ...
                <div class="container">
                    ...
                    <div class="testimonial-grid">
                        <div class="testimonial">
                            <div class="stars">★★★★★</div>
                            <p>"Medora has completely transformed how I manage my medications. I used to forget doses
                                regularly, but now I'm 100% compliant."</p>
                        ...
                        <div class="testimonial">
                            <div class="stars">★★★★★</div>
                            <p>"I recommend Medora to all my patients who struggle with medication adherence. The
                                improvement has been remarkable."</p>
                        ...
                        <div class="testimonial">
                            <div class="stars">★★★★★</div>
                            <p>"Being able to monitor my mother's medication remotely gives me incredible peace of mind.
                                The alerts keep her on track."</p>
            ...
            <section class="final-cta">
                <div class="container">
                    ...
                    <a href="${cp}/patient/register" class="btn primary large">Begin Your Journey</a>
                    <ul class="benefits">
