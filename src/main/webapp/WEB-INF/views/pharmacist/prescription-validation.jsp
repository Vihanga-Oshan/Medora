        ...
        <div class="container">
          <%@ include file="/WEB-INF/views/components/sidebar.jsp" %>
              ...
              <div class="validation-page-body">
                ...
                <c:if test="${empty prescriptions}">
                  <div class="no-data-card">
                    ...
                    <a href="${pageContext.request.contextPath}/pharmacist/dashboard" class="btn primary">Back to
                      Dashboard</a>
                  </div>
                </c:if>
            ...
            <div class="card-footer">
              <a href="${pageContext.request.contextPath}/pharmacist/prescription-review?id=${p.id}" class="view-details-btn">
