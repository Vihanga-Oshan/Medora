...
-- 5. FIX DATA TRUNCATION IN GUARDIAN TABLE
-- Increase password column length from 45 to 255 for SHA-256 hashes
ALTER TABLE guardian MODIFY COLUMN password VARCHAR(255);
