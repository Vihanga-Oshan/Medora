...
public class patient {
    ...
    private String linkStatus; // UNVERIFIED, REQUEST_SENT, LINKED
    ...
    public String getChronicIssues() {
        return chronicIssues;
    }

    public void setChronicIssues(String chronicIssues) {
        this.chronicIssues = chronicIssues;
    }
