...
public class ChatDAO {
    ...
    public boolean addMessage(ChatMessage msg) throws SQLException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(query)) {
            ...
            ps.setString(4, EncryptionUtil.encrypt(msg.getMessageText()));
    ...
    public List<com.example.base.model.ChatConversation> getPharmacistSupplierConversations() throws SQLException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(query);
            ...
            while (rs.next()) {
                ...
                conv.setLastMessage(EncryptionUtil.decrypt(rs.getString("message_text")));
        ...
        try (PreparedStatement ps = connection.prepareStatement(query)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    msg.setMessageText(EncryptionUtil.decrypt(rs.getString("message_text")));
    ...
    public int getTotalUnreadCount() throws SQLException {
        String query = "SELECT COUNT(*) FROM chat_messages WHERE receiver_id = 'PHARMACIST' AND is_read = 0";
        try (PreparedStatement ps = connection.prepareStatement(query);
                ResultSet rs = ps.executeQuery()) {
            if (rs.next()) {
                return rs.getInt(1);
