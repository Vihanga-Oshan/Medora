        ...
        switch (path) {
            ...
            case "/pharmacist/register":
                if ("POST".equals(method)) {
                    ...
                    forwardToJsp(req, resp, "/WEB-INF/views/auth/register-pharmacist.jsp");
                }
                break;
            ...
            case "/guardian/login":
                if ("POST".equals(method)) {
                    ...
                    forwardToJsp(req, resp, "/WEB-INF/views/auth/login-guardian.jsp");
                }
                break;
            ...
            case "/guardian/register":
                if ("POST".equals(method)) {
                    ...
                    forwardToJsp(req, resp, "/WEB-INF/views/auth/register-guardian.jsp");
                }
                break;
