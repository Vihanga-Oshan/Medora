            ...
            <section class="form-section">
              ...
              <form action="${pageContext.request.contextPath}/pharmacist/addMedicine" method="post"
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="generic_name" minlength="3" maxlength="100" placeholder="e.g. Paracetamol"
                    required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="category-input-group">
                    ...
                    <button type="button" onclick="openCategoryModal()" class="category-add-btn"
