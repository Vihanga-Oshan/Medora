                  ...
                  <tbody>
                    <c:forEach var="m" items="${medicineList}">
                      <tr>
                        ...
                        <td>$${m.price}</td>
                        <td>
                          <c:if test="${not empty m.imagePath}">
                            <a href="${m.imagePath}" target="_blank">View</a>
                          </c:if>
                        </td>
                        ...
                        <td>
                          ...
                          <div class="action-menu hidden">
                            <ul>
                              <li class="edit"
                                onclick="window.location.href='${pageContext.request.contextPath}/pharmacist/edit-medicine?id=${m.id}'">
                                &#9998; Edit
                              </li>
      ...
      <div id="deleteModal" class="modal hidden">
        <div class="modal-content">
          ...
          <div class="modal-actions">
            ...
            <form id="deleteForm" method="post" action="${pageContext.request.contextPath}/pharmacist/delete-medicine">
