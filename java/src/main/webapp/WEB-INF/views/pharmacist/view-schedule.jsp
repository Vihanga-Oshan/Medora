            ...
            <div class="schedule-viewer">
              ...
              <div class="schedule-table">
                ...
                <c:if test="${param.delete == 'success'}">
                  <div class="alert alert-success">✅ Schedule item deleted successfully.</div>
                </c:if>
                <c:if test="${param.delete == 'failure'}">
                  <div class="alert alert-error">❌ Found an error while deleting the schedule.</div>
                </c:if>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-actions">
                        ...
                        <form id="deleteForm" method="post"
                          action="${pageContext.request.contextPath}/pharmacist/delete-schedule">
                          <input type="hidden" name="nic" value="${patient.nic}" />
