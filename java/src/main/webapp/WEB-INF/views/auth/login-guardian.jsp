<%@ page contentType="text/html; charset=UTF-8" language="java" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      ...
      <title>Guardian Login - Medora</title>
    ...
    <body class="auth-page">
      ...
      <div class="auth-container animate-in">
        ...
        <p class="subtitle">Securely manage your patients' health records</p>

        <!-- Toggle Buttons -->
        <div class="form-toggle">
          <button type="button" onclick="location.href='${cp}/login'">Patient</button>
          <button class="active" type="button" onclick="location.href='${cp}/guardian/login'">Guardian</button>
        </div>
        ...
        <form method="post" action="${cp}/guardian/login" novalidate
          ...
          <p class="bottom-text">
            ...
            <a href="${cp}/guardian/register">Create Account</a>
          </p>
        </form>
      </div>
