                        ...
                        <div class="content-grid">
                            ...
                            <div class="timetable-column">
                                ...
                                <div class="card-panel">
                                    ...
                                    <c:if test="${not empty requestingGuardian}">
                                        <div class="alert-box"
                                            style="background: #e0f2fe; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #bae6fd;">
                                            <h4
                                                style="margin-top: 0; color: #0369a1; font-size: 1rem; margin-bottom: 8px;">
                                                Requests</h4>
                                            <p style="font-size: 0.9rem; color: #0c4a6e; margin-bottom: 12px;">
                                                <strong>${requestingGuardian.name}</strong> wants to verify as your
                                                guardian.
                                            </p>
                                            <div style="display: flex; gap: 10px;">
                                                <form action="${pageContext.request.contextPath}/patient/link-response"
                                                    method="post">
                                                    <input type="hidden" name="action" value="accept">
                                                    <button type="submit"
                                                        style="background: #0284c7; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 0.85rem;">Accept</button>
                                                </form>
                                                <form action="${pageContext.request.contextPath}/patient/link-response"
                                                    method="post">
                                                    <input type="hidden" name="action" value="decline">
                                                    <button type="submit"
                                                        style="background: white; color: #0284c7; border: 1px solid #0284c7; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 0.85rem;">Decline</button>
                                                </form>
                                            </div>
                                        </div>
                                    </c:if>
