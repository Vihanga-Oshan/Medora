...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const gf = document.getElementById("guardianForm") ||
        document.querySelector('form[action*="/guardian/register"]');
    if (gf) {
    ...
    const pf = document.getElementById("patientForm") ||
        document.querySelector('form[action*="/patient/register"]');
    if (pf) {
    ...
    document.querySelectorAll('form[action$="/login"], form[action$="/guardian/login"]').forEach(f => {
