    ...
    <div class="onboarding-container">
        ...
        <div class="onboarding-content">
            ...
            <div class="onboarding-form-container">
                ...
                <form class="onboarding-form" id="severityForm" method="POST" action="<?= htmlspecialchars($base) ?>/auth/onboarding/step3">
                    ...
                    <div class="form-actions multi-button" style="margin-top: 30px;">
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='<?= htmlspecialchars($base) ?>/auth/onboarding/step2'">Back</button>
