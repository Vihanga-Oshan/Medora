<?php
$pageTitle = 'Medora - Lifestyle Information';
    ...
    <div class="onboarding-container">
        ...
        <div class="onboarding-content">
            ...
            <div class="onboarding-form-container">
                ...
                <form class="onboarding-form" id="substanceForm" method="POST" action="<?= htmlspecialchars($base) ?>/auth/onboarding/step2">
                    ...
                    <div class="form-actions multi-button">
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='<?= htmlspecialchars($base) ?>/auth/onboarding/step1'">Back</button>
