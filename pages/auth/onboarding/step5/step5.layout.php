    ...
    <div class="onboarding-container">
        <header>
            <div class="logo-container" style="padding: 10px;">
                <img src="<?= htmlspecialchars($base) ?>/assets/img/logo.png" alt="Medora Logo" class="logo">
                <span class="logo-text">Med<br>ora</span>
            </div>
        </header>
        ...
        <div class="onboarding-content" style="justify-content: center;">
            <div class="completion-container" style="max-width: 600px; margin: 0 auto; width: 100%;">
                ...
                <h1 class="completion-title">Welcome to Medora!</h1>
                ...
                <div class="dashboard-actions">
                    <button class="primary-action" onclick="window.location.href='<?= htmlspecialchars($base) ?>/patient/dashboard'">
                    ...
                    <div class="secondary-actions" style="margin-top: 20px;">
                        ...
                        <button class="btn btn-text" onclick="window.location.href='<?= htmlspecialchars($base) ?>/auth/onboarding/step1'" style="text-decoration: underline;">
                            Review Settings
                        </button>
                    </div>
                </div>
