    ...
    <div class="dashboard-wrapper">
        <header class="dashboard-hero">
            ...
            <div class="hero-actions">
                <a href="<?= htmlspecialchars($base) ?>/guardian/patients" class="btn btn-primary"><img
                        src="<?= htmlspecialchars($base) ?>/assets/icons/user.png" class="hero-btn-icon" alt=""
                        aria-hidden="true"> Manage Patients</a>
                <a href="<?= htmlspecialchars($base) ?>/guardian/alerts" class="btn btn-outline"><img
                        src="<?= htmlspecialchars($base) ?>/assets/icons/bell.png" class="hero-btn-icon" alt=""
                        aria-hidden="true"> View Alerts</a>
            </div>
        </header>
            ...
            <section class="stats-overview">
                <div class="stat-card">
                    <div class="stat-icon-wrapper bg-blue">
                        <img src="<?= htmlspecialchars($base) ?>/assets/icons/user.png" class="icon-svg" alt=""
                            aria-hidden="true">
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-icon-wrapper bg-green">
                        <img src="<?= htmlspecialchars($base) ?>/assets/icons/average.png" class="icon-svg" alt=""
                            aria-hidden="true">
                    </div>
                    <div class="stat-details">
                    ...
                    <div class="card-panel adherence-panel">
                        ...
                        <div class="adherence-widget">
                            <div class="adherence-chart"
                                style="--adherence-deg: <?= max(0, min(100, (int) $avgAdherence)) * 3.6 ?>deg;">
                                ...
                                <?php foreach ($patients as $p): ?>
                                    <div class="timetable-row">
                                        ...
                                        <a class="btn btn-outline"
                                            href="<?= htmlspecialchars($base) ?>/guardian/patients?nic=<?= urlencode((string) $p['nic']) ?>">View</a>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
                            ...
                            <ul class="notification-list-widget">
                                <?php foreach ($recentAlerts as $a): ?>
                                    ...
                                    <li class="notification-item">
                                        ...
                                        <span
                                            class="status-pill <?= $pillClass ?>"><?= htmlspecialchars(strtoupper((string) ($a['type'] ?? 'INFO'))) ?></span>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
