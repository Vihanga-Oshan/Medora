        ...
        <div class="container hero-content">
            <div class="hero-text">
                ...
                <ul class="features-list">
                    ...
                    <li>Real-time reminders and alerts</li>
                    <li>Guardian monitoring and support</li>
                </ul>
            ...
            <div class="hero-image">
                <img src="<?= htmlspecialchars($base) ?>/assets/img/hero-image.jpg" alt="Doctor using digital tablet">
                <div class="badge">
                    <h4>99.9%</h4>
