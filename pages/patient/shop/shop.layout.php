    ...
    <div class="shop-layout">
        <aside class="shop-sidebar">
            <div class="sidebar-card">
                ...
                <ul class="category-list">
                    <li>
                        <a href="<?= htmlspecialchars($base) ?>/patient/shop"
                            class="<?= $currentCategory === '' ? 'active' : '' ?>">All Medicines</a>
                    </li>
                    <?php foreach ($categories as $cat): ?>
                        <li>
                            <a href="<?= htmlspecialchars($base) ?>/patient/shop?category=<?= urlencode((string) $cat) ?>"
        ...
        <main class="shop-main">
            ...
            <?php if (!empty($flash['message'])): ?>
                <div
                    style="background:#f0fdf4; border:1px solid #86efac; color:#166534; border-radius:12px; padding:12px 14px; margin-bottom:16px;">
                ...
                <?php foreach ($medicines as $med): ?>
                    ...
                    <div class="medicine-card med-clickable"
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form method="post" action="<?= htmlspecialchars($base) ?>/patient/shop/cart/add"
                                class="quick-add-form" onsubmit="event.stopPropagation();">
            ...
            <?php if (empty($medicines)): ?>
                <div style="text-align:center; padding:50px; color:#666;">
                    ...
                    <a href="<?= htmlspecialchars($base) ?>/patient/shop" style="color:#007dca; text-decoration:none;">Clear
                        Filters</a>
                </div>
            <?php endif; ?>
        </main>
        ...
        <div class="medicine-modal">
            ...
            <div class="medicine-modal-body">
                ...
                <div class="medicine-modal-details">
                    ...
                    <div style="font-weight:800; font-size:1.6rem; color:#0f172a;">Rs. <span id="modalPrice">0.00</span>
                    </div>
                    <div class="modal-stock" id="modalStock"></div>

                    <form method="post" action="<?= htmlspecialchars($base) ?>/patient/shop/cart/add" id="modalAddForm"
                        class="modal-actions">
                        <input type="hidden" name="id" id="modalMedicineId" value="0">
                        <input type="number" name="quantity" id="modalQty" min="1" value="1">
                        <button type="submit" class="btn-add-cart" id="modalAddBtn"><span>&#10010;</span> Add to
                            Cart</button>
