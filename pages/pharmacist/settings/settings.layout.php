            ...
            <section class="settings-wrap">
                ...
                <div class="settings-grid">
                    <article class="settings-card">
                        <h3>Account</h3>
                        <div class="kv">
                            <span>Name</span><strong><?= htmlspecialchars((string) ($user['name'] ?? 'Pharmacist')) ?></strong>
                        </div>
                        <div class="kv">
                            <span>Email</span><strong><?= htmlspecialchars((string) ($user['email'] ?? '-')) ?></strong>
                        </div>
                        <div class="kv">
                            <span>Phone</span><strong><?= htmlspecialchars((string) ($user['phone'] ?? '-')) ?></strong>
                        </div>
                        <div class="kv">
                            <span>License</span><strong><?= htmlspecialchars((string) ($user['licenseNo'] ?? '-')) ?></strong>
                        </div>
                    </article>
                    ...
                    <article class="settings-card">
                        ...
                        <a class="settings-link" href="<?= htmlspecialchars($base) ?>/pharmacist/medication-plans">Open
                            Medication Plans</a>
                    </article>
                </div>
            </section>
