            ...
            <section class="form-section">
                <div class="section-header">
                    <div>
                        ...
                        <p>Fill in required details to create a medicine entry</p>
                    </div>
                    <a class="add-btn"
                ...
                <form action="" method="post" enctype="multipart/form-data" class="styled-form" id="medicineForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="brand_new" list="brand-options"
                    ...
                    <div class="form-group"><label>Generic Name</label><input type="text" name="generic_name"
                            value="<?= htmlspecialchars((string) ($_POST['generic_name'] ?? '')) ?>"></div>
                    <div class="form-group"><label>MEDICINE NAME <span style="color:#dc2626;">*</span></label><input
                            type="text" name="med_name"
                            value="<?= htmlspecialchars((string) ($_POST['med_name'] ?? '')) ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="manufacturer_new" list="manufacturer-options"
                    ...
                    <div class="form-group full-width"><label>Description</label><textarea
                            name="description"><?= htmlspecialchars((string) ($_POST['description'] ?? '')) ?></textarea>
                    </div>
                    ...
                    <div class="form-group"><label>Strength <span style="color:#dc2626;">*</span></label><input
                            ...
                            value="<?= htmlspecialchars((string) ($_POST['strength'] ?? '')) ?>"
                    ...
                    <div class="form-group"><label>Doses per Unit</label><input type="number" name="unit_quantity"
                            min="1" value="<?= htmlspecialchars((string) ($_POST['unit_quantity'] ?? '1')) ?>"></div>
                    <div class="form-group"><label>Current Stock (Units)</label><input type="number"
                            name="quantity_in_stock" min="0"
                            value="<?= htmlspecialchars((string) ($_POST['quantity_in_stock'] ?? '0')) ?>"></div>
                    ...
                    <div class="form-group"><label>Unit Cost</label><input type="number" name="unit_cost" step="0.01"
                            min="0"
                            value="<?= htmlspecialchars((string) ($_POST['unit_cost'] ?? ($_POST['price'] ?? '0'))) ?>">
                    </div>
                    ...
                    <div class="form-group"><label>Expiry Date</label><input type="date" name="expiry_date"
                            value="<?= htmlspecialchars((string) ($_POST['expiry_date'] ?? '')) ?>"></div>
                    <div class="form-group"><label>Batch Number</label><input type="text" name="batch_number"
                            value="<?= htmlspecialchars((string) ($_POST['batch_number'] ?? '')) ?>"
                            placeholder="Batch / lot number"></div>
                    <div class="form-group"><label>Medicine Image</label><input type="file" name="imageFile"
                            accept="image/*"></div>

                    <div class="btn-group"><button type="submit" class="btn-submit">Add Medicine to Inventory</button>
                    </div>
                </form>
            </section>
        </main>
