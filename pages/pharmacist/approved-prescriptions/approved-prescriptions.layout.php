                ...
                <?php foreach ($approvedPrescriptions as $p): ?>
                    ...
                    <div class="prescription-card">
                        <div class="preview-container">
                            ...
                            <?php else: ?>
                                <img src="<?= htmlspecialchars($base) ?>/prescriptions/file?id=<?= (int)$p['id'] ?>" alt="Prescription" class="preview-image">
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="card-footer">
                            <a href="<?= htmlspecialchars($base) ?>/pharmacist/schedule?id=<?= (int)$p['id'] ?>&nic=<?= urlencode((string)$p['patient_nic']) ?>" class="view-details-btn">
