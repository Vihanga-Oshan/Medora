...
<nav class="pharmacist-navbar">
    ...
    <ul class="nav-links">
        ...
        ?>
        <li class="<?= $isDashboard ? 'active' : '' ?>"><a
                href="<?= htmlspecialchars($base) ?>/pharmacist/dashboard"><i>&#9962;</i> Dashboard</a></li>
        <li class="<?= $isValidate ? 'active' : '' ?>"><a
                href="<?= htmlspecialchars($base) ?>/pharmacist/validate"><i>&#128196;</i> Prescription Review</a></li>
        <li class="<?= $isApproved ? 'active' : '' ?>"><a
                href="<?= htmlspecialchars($base) ?>/pharmacist/approved-prescriptions"><i>&#9989;</i> Approved
                Prescriptions</a></li>
        <li class="<?= $isPatients ? 'active' : '' ?>"><a
                href="<?= htmlspecialchars($base) ?>/pharmacist/patients"><i>&#128101;</i> Patients</a></li>
