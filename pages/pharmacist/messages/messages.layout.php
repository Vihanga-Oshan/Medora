                ...
                <section class="chat-layout pharmacist-chat-layout">
                    <div class="contact-list">
                        <div class="contact-tabs">
                            <a class="tab-link <?= $chatType === 'patients' ? 'active' : '' ?>"
                                href="<?= htmlspecialchars($base) ?>/pharmacist/messages?type=patients">Patients</a>
                            <a class="tab-link <?= $chatType === 'suppliers' ? 'active' : '' ?>"
                                href="<?= htmlspecialchars($base) ?>/pharmacist/messages?type=suppliers">Suppliers</a>
                        </div>
                        ...
                        <?php foreach ($contacts as $contact): ?>
                            ...
                            if (strlen($preview) > 52)
                                $preview = substr($preview, 0, 52) . '...';
                            ...
                            <a href="<?= htmlspecialchars($contactUrl) ?>"
                                class="contact-item <?= $isActive ? 'active' : '' ?> <?= $unread > 0 ? 'has-unread' : '' ?>">
                    ...
                    <div class="chat-window <?= $selectedContact ? 'has-selection' : '' ?>">
                        ...
                        <div class="chat-container">
                            <div class="chat-header">
                                ...
                                <div>
                                    <h3 id="current-chat-name">
                                        <?= htmlspecialchars($selectedContact['name'] ?? 'Conversation') ?></h3>
                            ...
                            <?php if ($selectedContact): ?>
                                <form method="post" class="chat-input-area">
                                    ...
                                    <input type="text" class="chat-input" name="message" maxlength="1000"
