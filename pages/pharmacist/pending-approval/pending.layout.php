    ...
    <div class="auth-shell">
        <section class="auth-form-panel">
            <div class="login-container">
                ...
                <?php if ($error): ?>
                    ...
                    <p class="bottom-text"><a href="<?= htmlspecialchars($base) ?>/pharmacist/login">Go to pharmacist
                            login</a></p>
                <?php elseif ($status === 'rejected'): ?>
                    <h1>Request Rejected</h1>
                    <p class="subtitle">Your request was rejected by admin.</p>
                    <p class="subtitle">Reason: <?= htmlspecialchars((string) ($request['note'] ?? 'No reason provided')) ?>
                    </p>
                    <p class="bottom-text"><a href="<?= htmlspecialchars($base) ?>/pharmacist/register">Submit new
                            request</a></p>
                <?php else: ?>
        ...
        <aside class="auth-visual-panel">
            <div class="visual-card">
                <img src="<?= htmlspecialchars($base) ?>/assets/img/logo.png" alt="Pending approval">
