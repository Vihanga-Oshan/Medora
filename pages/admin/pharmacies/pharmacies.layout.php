...
<body class="admin-body">
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="active"><a href="<?= htmlspecialchars($base) ?>/admin/pharmacies"><i>&#127973;</i> Pharmacies</a>
            </li>
                    ...
                    <tbody>
                        <?php foreach ($pharmacies as $p): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars((string) $p['latitude']) ?>,
                                    <?= htmlspecialchars((string) $p['longitude']) ?>
                                </td>
