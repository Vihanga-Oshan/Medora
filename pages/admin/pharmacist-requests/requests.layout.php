        ...
        <section class="panel-card requests-card">
            ...
            <table class="data-table">
                ...
                <?php if (empty($requests)): ?>
                    <tr><td colspan="<?= $showActions ? '6' : '5' ?>">No requests found.</td></tr>
                <?php endif; ?>
                <?php foreach ($requests as $r): ?>
                    <?php $rowStatus = strtolower((string)($r['status'] ?? '')); ?>
                    <tr>
                            ...
                            <td>
                                <?php if ($rowStatus === 'pending'): ?>
                                    ...
                                    <form method="post" style="display:inline;">
                                        ...
                                        <button class="btn btn-danger btn-small" type="submit" onclick="return confirm('Reject this pharmacist request?');">Reject</button>
                                    </form>
                                <?php endif; ?>
                            </td>
                        <?php endif; ?>
