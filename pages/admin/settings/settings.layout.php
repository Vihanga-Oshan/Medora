...
<body class="admin-body admin-settings-page">
    ...
    <aside class="sidebar">
        <div class="logo">
            <img src="<?= htmlspecialchars($base) ?>/assets/img/logo.png" alt="Medora"
                onerror="this.style.display='none'">
            <span>Medora Admin</span>
        </div>
        <ul class="nav-links">
            <li><a href="<?= htmlspecialchars($base) ?>/admin/dashboard"><i>&#128202;</i> Dashboard</a></li>
            <li><a href="<?= htmlspecialchars($base) ?>/admin/pharmacists"><i><img
                            src="<?= htmlspecialchars($base) ?>/assets/icons/pill.png" alt="" aria-hidden="true"
                            style="width:1em;height:1em;object-fit:contain;display:block;"></i> Pharmacists</a></li>
            <li><a href="<?= htmlspecialchars($base) ?>/admin/pharmacies"><i>&#127973;</i> Pharmacies</a></li>
            <li><a href="<?= htmlspecialchars($base) ?>/admin/pharmacy-assignments"><i>&#128279;</i> Assignments</a>
            </li>
        ...
        <div class="admin-profile js-admin-profile">
            <button type="button" class="admin-profile-trigger" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="profile-info">
                    <div class="name"><?= htmlspecialchars($adminEmail ?? ($user['email'] ?? 'admin@medora.com')) ?>
                    </div>
                </div>
            </button>
        ...
        <section class="settings-shell">
            <div class="settings-card-v2">
                ...
                <?php if (!empty($success)): ?>
                    ...
                    <div id="admin-last-updated" class="update-meta" data-updated-at="<?= time() ?>">Last updated just now
                    </div>
                <?php endif; ?>
                ...
                <div class="settings-form-v2">
                    <div class="field-group">
                        ...
                        <input id="admin-full-name" type="text"
                            value="<?= htmlspecialchars((string) ($admin['full_name'] ?? ($user['name'] ?? 'Admin'))) ?>"
                            readonly>
                    </div>
                    ...
                    <form method="post" id="email-change-form" class="credential-row">
                        ...
                        <div class="field-group credential-field">
                            ...
                            <div class="input-with-actions">
                                <input id="admin-email" type="email" name="admin_email"
                                    value="<?= htmlspecialchars((string) ($admin['email'] ?? '')) ?>"
                                    data-original-value="<?= htmlspecialchars((string) ($admin['email'] ?? '')) ?>"
                                    readonly>
                                <div class="inline-actions">
                                    <button id="email-change-btn" type="button"
                                        class="btn btn-muted btn-small credential-btn">Change</button>
                                    <button id="email-cancel-btn" type="button"
                                        class="btn btn-cancel btn-small credential-btn is-hidden">Cancel</button>
                                    <button id="email-save-btn" type="submit"
                                        class="btn btn-save btn-small credential-btn is-hidden">Save</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="credential-row">
                        <div class="field-group credential-field">
                            ...
                            <div class="input-with-actions">
                                ...
                                <div class="inline-actions">
                                    <button id="password-change-btn" type="button"
                                        class="btn btn-muted btn-small credential-btn">Change</button>
                                </div>
                            </div>
                        </div>
            ...
            <div id="password-change-card"
                class="settings-card-v2 settings-password-card<?= $showPasswordCard ? '' : ' is-hidden' ?>">
                <div class="settings-card-head">
                    <span class="head-icon">&#128274;</span>
                    <div>
                ...
                <form method="post" class="settings-form-v2">
                    ...
                    <div class="field-group">
                        ...
                        <input id="new-password" type="password" name="new_password" placeholder="At least 8 characters"
                            required>
                    </div>
                    <div class="field-group">
