...
<body class="admin-body">
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="active"><a href="<?= htmlspecialchars($base) ?>/admin/pharmacy-assignments"><i>&#128279;</i>
                    Assignments</a></li>
                ...
                <form method="post" class="admin-grid admin-grid-4">
                    ...
                    <select name="pharmacist_id" required>
                        ...
                        <?php foreach ($pharmacists as $p): ?>
                            <option value="<?= (int) $p['id'] ?>"><?= htmlspecialchars((string) $p['name']) ?>
                                (<?= htmlspecialchars((string) $p['email']) ?>)</option>
                        <?php endforeach; ?>
                    </select>
