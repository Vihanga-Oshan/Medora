...
<body class="admin-body admin-pharmacists-page">
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="active"><a href="<?= htmlspecialchars($base) ?>/admin/pharmacists"><i><img
    ...
    <main class="main-content">
        ...
        <div class="section-container">
            <div class="section-header">
                ...
                <a href="<?= htmlspecialchars($base) ?>/admin/pharmacists/add" class="btn btn-primary">+ Add
                    Pharmacist</a>
            </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if (empty($pharmacists)): ?>
                            <tr>
                                <td colspan="4" class="empty-msg">No pharmacists found.</td>
                            </tr>
                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-content">
                                                <a
                                                    href="<?= htmlspecialchars($base) ?>/admin/pharmacists/edit?id=<?= $ph['id'] ?>">Edit
                                                    Profile</a>
                                                <form action="<?= htmlspecialchars($base) ?>/admin/pharmacists/delete"
                                                    method="post" onsubmit="return confirm('Suspend this pharmacist?')">
